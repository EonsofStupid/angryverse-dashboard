  ...
  return (
    <BackgroundContainer className="py-20">
      ...
      <div className="container mx-auto px-4">
        <div className="w-full h-[600px] overflow-hidden rounded-xl bg-[#1A1F2C]/50 p-8 relative">
          <div className={`relative ${!user ? 'filter blur-sm' : ''}`}>
            {nodes.map((node) => (
              ...
              >
                <node.icon className="w-8 h-8 text-[var(--theme-colors-cyber-purple)]" />
              ...
              {edges.map((edge, index) => {
                ...
                return (
                  <motion.line
                    ...
                    x2={`${toNode.id * 20}%`}
                    y2={`${toNode.id * 15}%`}
                    stroke="var(--theme-colors-cyber-purple)"
                    strokeWidth="2"
                    strokeDasharray="5,5"
          ...
          {!user && (
            <div className="absolute inset-0 flex items-center justify-center" style={glassStyle}>
              ...
              >
                <Lock className="w-12 h-12 text-[var(--theme-colors-cyber-purple)] mx-auto" />
                ...
                <Button 
                  ...
                  className="mt-4"
                  style={{
                    background: `linear-gradient(135deg, var(--theme-colors-cyber-purple), var(--theme-colors-cyber-cyan))`,
